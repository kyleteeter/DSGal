        ...
        <Container maxW={'7xl'}>
          ...
          >
            <Stack flex={1} spacing={{ base: 5, md: 10 }} ml={10} mr={10}>
              ...
              <Text color={'gray.500'}>To me, data is more than just numbers—it’s a powerful tool for uncovering insights, driving decisions, and fostering business growth. I specialize in transforming complex datasets into actionable insights through data preparation, reporting, and visualizations, helping organizations make smarter, data-driven decisions.</Text>
