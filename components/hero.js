        ...
        <Container maxW={'7xl'}>
          ...
          >
            <Stack flex={1} spacing={{ base: 5, md: 10 }} ml={10} mr={10}>
              ...
              <Text color={'gray.500'}>
                My passion lies in delving deep into the data and uncovering the
                insights that drive informed decision-making with a focus on
                transforming raw data into easy-to-understand, actionable
                stories.
              </Text>
